...
SAMPLE_DASHBOARD_API_DATA: dict[str, dict[str, Any]] = {
    ...
    "operator_reviews": {
        ...
        "count": 2,
        "items": [
            {"review_id": "review-sample-001", "status": "open", "severity": "medium"},
            {"review_id": "review-sample-002", "status": "open", "severity": "high"},
        ],
        "summary": {"review_count": 2, "approval_required_count": 2},
        "generated_at": "sample-generated-at",
        "raw_payload_stored": False,
        "automatic_changes": False,
        "administrator_controlled": True,
    ...
    "diagnostics": {
        "status": "ok",
        "count": 1,
        "items": [{"diagnostic_id": "diagnostic-sample-001", "diagnostic_type": "schema_validation", "status": "ok"}],
