...
def test_pyproject_includes_local_config_and_docs_data_files():
    ...
    assert "docs/PHASE_153_158_PLAN.md" in data_files["share/portmap-ai/docs"]
    assert "docs/PHASE_159_164_PLAN.md" in data_files["share/portmap-ai/docs"]
    assert "docs/PHASE_165_170_PLAN.md" in data_files["share/portmap-ai/docs"]
    ...
    assert "docs/cloud_relay_infrastructure.md" in data_files["share/portmap-ai/docs"]
    ...
    assert "docs/edge_worker_modes.md" in data_files["share/portmap-ai/docs"]
    ...
    assert "docs/horizontal_scaling.md" in data_files["share/portmap-ai/docs"]
    ...
    assert "docs/compliance_profiles.md" in data_files["share/portmap-ai/docs"]
    assert "docs/data_governance_controls.md" in data_files["share/portmap-ai/docs"]
    assert "docs/operator_accountability.md" in data_files["share/portmap-ai/docs"]
    assert "docs/security_review_framework.md" in data_files["share/portmap-ai/docs"]
    assert "docs/privacy_legal_safeguards.md" in data_files["share/portmap-ai/docs"]
    ...
    assert "docs/linux_packaging_readiness.md" in data_files["share/portmap-ai/docs"]
    assert "docs/macos_packaging_readiness.md" in data_files["share/portmap-ai/docs"]
    assert "docs/windows_installer_readiness.md" in data_files["share/portmap-ai/docs"]
