...
- Milestones AA through AD remain reserved for packaging and installers, compliance and governance, AI intelligence evolution, and commercial launch readiness as tracked in `docs/PORTMAP_AI_FINAL_ROADMAP.md`.
