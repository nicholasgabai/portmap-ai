...
- Milestone Z scalability and distributed infrastructure is planned in `docs/PHASE_153_158_PLAN.md`. Phases 153-158 will model distributed telemetry bus envelopes, bounded queues, high-volume storage readiness, horizontal scaling, resource optimization, edge worker modes, and cloud relay readiness while avoiding external broker dependencies, live cloud provisioning, destructive storage actions, enforcement, firewall/process/service changes, credential storage, and private identifier export.
