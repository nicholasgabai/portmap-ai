...
Milestone Y planning is tracked in `docs/PHASE_147_152_PLAN.md` for AI correlation records, advisory threat scoring expansion, and local threat-hunting query models without final threat verdicts, blocking, enforcement, external threat-feed lookups, payload storage, raw DNS history, or private identifiers.
