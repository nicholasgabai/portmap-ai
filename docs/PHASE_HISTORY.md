...
Milestone Y planning is tracked in `docs/PHASE_147_152_PLAN.md` for advisory threat scoring expansion and local threat-hunting query models without final threat verdicts, blocking, enforcement, external threat-feed lookups, external AI calls, payload storage, raw DNS history, or private identifiers.
