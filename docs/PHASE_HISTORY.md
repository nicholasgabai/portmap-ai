...
Milestone Y planning is tracked in `docs/PHASE_147_152_PLAN.md` for local threat-hunting query models without final threat verdicts, malicious labels, blocking, enforcement, external threat-feed lookups, external AI calls, payload storage, raw DNS history, or private identifiers.
