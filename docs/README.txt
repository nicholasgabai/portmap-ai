...
- `docs/PHASE_147_152_PLAN.md` - milestone plan for threat intelligence and detection expansion: IOC models, DNS threat analytics, local signatures, AI correlation records, advisory threat scoring, and local threat-hunting query models.
