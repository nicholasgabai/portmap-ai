...
- `docs/tui_dashboard.md` - Textual dashboard panels, Phase 170.5 multi-tab navigation, Phase 170.5A-170.5A.5 one-screen Risk investigation dashboard, controls, data sources, and source-mode labeling.
