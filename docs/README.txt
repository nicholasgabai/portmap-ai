...
- `docs/tui_dashboard.md` - Textual dashboard panels, Phase 170.5 multi-tab navigation, Phase 170.5A-170.5A.4 Risk investigation workspace, controls, data sources, and source-mode labeling.
